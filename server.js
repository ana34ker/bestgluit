...
const youtube = new YouTube("AIzaSyABUFTd21Lxn-wUhhXiC9s1JR2qrfCp2Sc"); //تعديل اساسي سوي اي بي اي جديد
...
client.on('ready', () => {
    ...
    client.user.setActivity(`https://discord.gg/5hJXRxA `,{type: 'Playing'}); ///التعديل علي البلاينج
});
...
client.on('message' , message => {
    ...
    if(message.content.startsWith(prefix + 'unban')) {
        if(!message.member.hasPermission('ADMINISTRATOR')) return message.channel.send('❌|**\`ADMINISTRATOR\`You Dont Have Permission`**');
...
client.on('guildMemberAdd', member => {
  ...
  let msg2 = '> **Welcome To Guilty Community** 💎 '
  let msg3 = '> **User** : [user]'
...
msg.guild.setIcon(args)
 ...
 .then(g => msg.reply(`> **Server Name Changed ${g} ✅**`))
 .catch(console.error);
}
});
...
client.on("message", message => {
  if (message.content === prefix + "help") {
    const bot = new Discord.RichEmbed()
      ...
      .setColor("#00000")
      .addField("**<a:713201109103280189:746867165298425968>  Public Commands** :  ", `» **%avatar, %report, %savatar, %xo, %ping, %user** `, true) //id
      .addField("**<a:651720016651354112:744300387540140042>  Admin Commands** :  ", `» **%ban, %clear, %unban, %lock, %unlock, %kick, %setServerIcon, %setServerName** `, true) //id
      .addField("**<a:600967611353923606:744300385807761488>  Music Commands** :  ", `» **%play, %pause, %np, %skip, %skipto, %stop, %volume, %repeat** `, true) //id
